...
![](/assets/images/Candle1-7ce6b2.jpg)
...
![](/assets/images/Candle2-e24b6e.jpg)
...
That said, there are some yellow flags: it’s mostly an older body of literature, which might mean worse methods. For example, the study I described included only male psychology undergrads. However, there is a 2009 [study](https://rady.ucsd.edu/_files/faculty-research/uri-gneezy/large-stakes.pdf) that came to the same conclusion.

Possibly we should be skeptical of all psychology findings, given that some attempts to [replicate](https://www.science.org/doi/10.1126/science.aac4716) studies can reproduce less than half of the original findings. Even when studies replicate, the effect size often changes wildly. One [study](https://www.nature.com/articles/s41562-018-0399-z) found that effect sizes decreased by 50% on average when replicated.
...
So if you’re constantly trying to cram eighteen tasks into fifteen minutes and wondering why you aren’t having any new ideas, then feel free to take some pressure off. Make time to be [bored](https://docs.google.com/document/d/1SUU3WVCsXKBLx0IUZoz9K939khuDV5VUD7grBgJ5Wis/edit?usp=sharing).
