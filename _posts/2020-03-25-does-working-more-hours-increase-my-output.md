...
After writing up [my research on limits to working](/blog/2020/3/20/how-long-can-people-usefully-work), the sheer spread of possibilities amazed me. I genuinely wasn’t sure if I would be able to tell the difference between a day with four hours of deep work and one with eight hours. Surely we could narrow down the hypothesis space from that!
...
![](/assets/images/Predictionintervalpre-f56c7e.png)
...
![](/assets/images/table-de1f5a.png)
...
![](/assets/images/Wordsperhoursofwriting-ab8f01.png)
...
It worked best to do shallow work (such as proofing a transcription) or switch to a different piece when I felt stuck. My rule of thumb would be to stop if the writing isn’t flowing after ten minutes, though I could see this being easy to [Goodhart](https://www.lesswrong.com/posts/YtvZxRpZjcFNwJecS/the-importance-of-goodhart-s-law) in the future.
...
3. Motivation matters, maybe. I was tired of writing, and my [RSI](https://www.nhs.uk/conditions/repetitive-strain-injury-rsi/) was flaring up, by midway through the second eight-hour day. I wouldn’t be surprised if some of the slump in output was related to motivation. So, if someone really wanted to write for twelve hours a day, they might be just fine.
...
And I also think it’s possible that all of that could be wrong. [Did I notice a big effect because I expected a big effect?](https://slatestarcodex.com/2020/02/17/sleep-support-an-individual-randomized-controlled-trial/) Maybe. Was my sample size too small? Yeah. Were my methods susceptible to bias? Yes.
...
![](/assets/images/Predictionintervalpost-8eb49c.png)
