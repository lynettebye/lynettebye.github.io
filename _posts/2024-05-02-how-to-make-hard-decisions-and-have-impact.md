...
When you only have the abstract advice, it can be hard to [apply](https://commoncog.com/how-note-taking-can-help-you-become-an-expert/) to all of the situations where you need it. Personal fit tests for someone exploring bio careers are going to look very different than my tests for journalism. It’s also easy to *think* you understand the advice, when actually you’re [missing](https://www.lesswrong.com/posts/k9dsbn8LZ6tTesDS3/sazen) important details.

For example, 80,000 Hours has some great [advice](https://80000hours.org/career-planning/process/feedback-and-investigation/) on investigating uncertainties. However, beyond talking to people and reading their posts, their advice for testing is “Look for ways to test your uncertainties.” They give one example of what this might look like, but one example isn’t enough. That sentence deserves its own entire blog post!
...
![](/assets/images/Iamabsolutelyparalyzedbydecisionmaking2Canditisdestroyingmyimpact21-acce90.jpg)
...
Rich data is usually external. There’s a detailed, nuanced world out there, and you need to have lots of data points from bumping into it. Get your [hands dirty](https://mindingourway.com/dive-in-2/)! Go talk to people, try things, learn how the world works.
...
[Ben Kuhn](https://www.benkuhn.net/behavioral/#:~:text=My%20formula%20for%20kicking%20off,and%20how%20you%20addressed%20it.) uses a careful approach to planning behavioral interviews to extract enough data that he can make informed hiring decisions.
...
You likely won’t feel convinced you know enough to cut off all the other paths. You’re trying to gain more robust clarity – where it’s harder to get new information that would change your choice. (See [How much career exploration is enough?](/blog/2024/4/7/how-much-career-exploration-is-enough))
...
When Kit Harris wanted to reassess his career, he started from scratch. (You can read his longer account of the process [here](https://docs.google.com/document/d/1QxRYEnINNUBr2anSdfc5dVdaTnV5muiWzpvdT4-scDQ/edit).)
...
“With our 2020 charity research, that meant doing a quick 30-minute prioritization of hundreds of ideas, then a longer two-hour prioritization of dozens of ideas, and, finally, an 80-hour prioritization of the top five to ten. Each level of depth examines fewer ideas than the previous round, but invests considerably more time into each one.” *From* [*How to launch a high-impact nonprofit*](https://www.goodreads.com/en/book/show/60132743)

[GiveWell](https://www.givewell.org/research/research-on-programs) and [Open Philanthropy](https://www.openphilanthropy.org/cause-selection/#content-2-1) use a similar process for selecting priority charities.

You can read a longer [description](https://www.charityentrepreneurship.com/post/using-a-spreadsheet-to-make-good-decisions-five-examples) here of Charity Entrepreneurship’s process from an early round.

## Allan Dafoe’s shallow research tests

*Jade* [*Leung’s*](/blog/2022/5/5/jade-leung) *account of how her former professor, Allan Dafoe, selected research projects:*
...
But you want to reevaluate that path once you get more information. You want to check whether you’re still on the right path as your model becomes more granular. Related: [Theory of Change as a Hypothesis](/blog/2020/11/16/theory-of-change-as-a-hypothesis)
...
When I was drafting the [ADHD](/blog/2023/4/20/inside-the-minds-of-adhd) post. I wanted to test how long it took me to conduct interviews, since I hadn’t done that for a post previously.
...
[You Aren't Learning If You Don't Close the Loops](https://commoncog.com/no-learning-dont-close-loops/) by Cedric Chin, author of CommonCog, emphasizes the importance of studying the results of experiments to actually learn from your trials. His system is a good example of systems for exploring bigger key uncertainties over time. Excerpt:
...
My blog post [Theory Of Change As A Hypothesis: Choosing A High-Impact Path When You’re Uncertain](/blog/2020/11/16/theory-of-change-as-a-hypothesis) was an earlier attempt to apply the importance of regular iteration for reducing uncertainty in career choice.

Logan Strohl’s [naturalism](https://www.lesswrong.com/s/evLkoqsbi79AnM5sz) posts are one way to think more about getting in close contact with the data. My guess is that you’ll know pretty quickly whether you click with his style, so feel free to check it out and move on if this one isn’t for you.
