...
This is a slight exaggeration – you don’t want a doctor in their first year out of medical school.[[1]](#_edn1) After that, it’s less clear. One review found thirty-two studies indicating that the older a doctor was, the worse their medical outcomes; that review only found *one* study indicating that all outcomes got better with increasing age.[[2]](#_edn2) Other analyses suggest that middle-aged doctors might do better than younger doctors (though the effect is not statistically significant)[[3]](#_edn3), but older doctors are still clearly worse than middle-aged doctors.[[4]](#_edn4)

It’s not like doctors become *terrible* with more experience, but they are measurably worse. In one study, an extra twenty years of experience translated to about one additional elderly patient dying out of every hundred treated.[[5]](#_edn5) Why would twenty extra years of practice make a doctor *worse* at helping people?

Similarly, some [research](https://www.washingtonpost.com/news/wonk/wp/2016/06/23/when-you-will-most-likely-hit-your-creative-peak-according-to-science/) on famous painters, writers[[6]](#_edn6), and composers[[7]](#_edn7) found that it’s most common for these artists to produce their best work before the age of 45. A famous composer is more likely to have written their best piece of music in their 20s than their 40s, and they’re almost twice as likely to have written their best piece in their 30s instead of their 50s.[[8]](#_edn8)
...
The result was kind of funny. The authors of one such paper wrote a New York Times piece called “[Sorry, Strivers: Talent Matters](https://www.nytimes.com/2011/11/20/opinion/sunday/sorry-strivers-talent-matters.html)” attempting to debunk deliberate practice by highlighting their finding that working memory determined 7% of success in their study. Meanwhile, their study also found that deliberate practice determined *45%* of success.[[10]](#_edn10)

Another study found that deliberate practice “only” determined one third of success[[11]](#_edn11), and a meta-analysis found that deliberate practice only predicted 11%.[[12]](#_edn12) Even the naysayers agree that deliberate practice is important; they just don’t believe that it *entirely* explains success.
...
In the above studies, the ones finding that deliberate practice accounts for 45% and one third of variance in performance were only looking at highly developed fields like music and chess. Highly developed fields have objective methods of evaluating performance (such as music competitions or chess ratings) and effective training methods, usually developed over decades or centuries. Meanwhile, the [meta-analysis](https://scottbarrykaufman.com/wp-content/uploads/2014/07/Macnamara-et-al.-2014.pdf) (which found that deliberate practice explained 11% of the variance in performance) looked at multiple fields.
...
He had to develop a meta-system for remembering groups of numbers before he could break that plateau. It took him more than 200 hours of practice to develop the techniques to be able to remember nearly 80 digits.[[13]](#_edn13) That’s a lot of time to develop techniques from scratch for a relatively simple task.

Ericsson claims that running, swimming, piano, and countless other fields have far higher standards today than they did a hundred years ago – because we’ve learned better techniques and training methods.[[14]](#_edn14) It took Newton to invent calculus, but since then we’ve refined the field and discovered better teaching methods. Now it's a skill that can be learned by the average high school student.
...
It seems possible that doctors and creatives stopped practicing because they couldn’t find new techniques to practice. Maybe we occasionally get a good, easy-to-use technique that lots of doctors adopt, like using [checklists](https://en.wikipedia.org/wiki/Checklist#Health_care) that reduce patient mortality by 23%.
...
I think the people who say  “Talent matters!” are pointing at a big chunk of the answer.[[15]](#_edn15) Fortunately, we can build a more detailed model of what it means to say someone is “talented”.

Psychiatrist [Scott](https://slatestarcodex.com/2017/01/13/why-do-test-scores-plateau/) Alexander [looked at med school data](https://slatestarcodex.com/2017/01/13/why-do-test-scores-plateau/) and found that medical students’ scores plateaued after about their third year. Students got steadily better in their first year. In year two, they learned a bit less but were still improving. But after year three, they barely increased their test scores. “Compare fourth-year and fifth-year surgeons, and it’s pretty close to 50-50 which of them will know more surgery.”
...
One deliberate practice [study](https://journals.sagepub.com/doi/abs/10.1177/0956797610373933) found that working memory explained 7% of success at sight reading music. Working memory capacity is one cognitive constraint at the point of learning. Other constraints impact the ability to remember information over time or process new information efficiently.
...
To attempt to disentangle which factors are contributing to skill plateaus, we can check if a skill known for deliberate practice follows the same skill plateau pattern as doctors and creatives. Doctors and creatives possibly get better until their thirties or early forties, then they get worse.[[17]](#_edn17)
...
Studies on chess players found that their performance declined after the age of 35 or 40.[[18]](#_edn18) Younger players got sharply better, then their performance tapered off as they got older. Additionally, if you look at the top chess players, almost all are in their twenties and thirties.[[19]](#_edn19) So, chess players fit a similar pattern of decline to doctors and creatives.
...
Maybe individuals should put more effort into deliberate practice. **More importantly, societies need people researching and developing better techniques and training methods so that individuals *can* do deliberate practice.**[[21]](#_edn21)
