...
- [Bay Area Adult ADHD](https://www.bayareaadultadhd.org/) worked pretty well for one person. I think they’re an assessment clinic that can assess you and recommend a treatment plan to your doctor, but not able to directly prescribe medication.
- One person worked with [Boston Neurobehavioral Associates](https://www.bostonneurobehavioral.com/) exclusively through Telehealth.
- Online services like [Done](https://www.donefirst.com/) are relatively accessible, but are under scrutiny as the telehealth rules change.
- One recommendation on the EA Mental Health Navigator was for [Talkiatry](https://www.talkiatry.com/), an online “group psychiatry practice that operates in multiple states, accepts most major insurances, and offers primarily medication management.”

The EA Mental Health Navigator provider [database](https://www.mentalhealthnavigator.co.uk/providers) has more recommendations for providers who can prescribe medication (you can filter by specialty for ADHD).
...
Psychiatrist Scott Alexander has an excellent overview [here](https://lorienpsych.com/2020/10/30/adderall/) with the medication he recommends. He also covers most of the other questions I hear -- possible side effects, tolerance, addiction, etc.

If you want more sources, UpToDate.com (a medical overview website for doctors) covers the [treatment of ADHD in adults](https://lorienpsych.com/2020/10/30/adderall/), including citing relevant studies. For a different approach, [StuffThatWorks](https://www.stuffthatworks.health) aggregates thousands of patient reviews to see which treatments work best.
...
You can also check your own symptoms against the questionnaire the doctor will use. My doctor used the [Adult ASRS Scale](https://drive.google.com/file/d/16sKcQ9eIZBbF6EdncrYA1-TW3Rb_tSiN/view?usp=sharing), which I think it’s the most common one. Scoring “often” or “very often” on 6 or more of the questions is suggestive of ADHD. (Specifically, I think my doctor was checking that I scored “often” or “very often” on 6 or more in childhood and 5 or more in adulthood.) The doctor will look at more factors, especially whether the symptoms are negatively impacting your life, but this gives you a good baseline.

# The diagnosis process with the psychiatrist

Before the diagnostic appointment, the doctor sent me three questionnaires. I filled in one, and the others were filled in by who knows me now and someone who knew me as a kid. I think these were all versions of the [Adult ASRS Scale](https://drive.google.com/file/d/16sKcQ9eIZBbF6EdncrYA1-TW3Rb_tSiN/view?usp=sharing). These checked whether I’d had symptoms spanning from childhood into adulthood that impacted my life now.
...
I had to meet with the doctor monthly until we figured out which medication and dose was best for me. I tracked a bunch of metrics over the titration period (especially the first month) to measure how the meds worked. You can see those experiments [here](https://docs.google.com/document/d/10nb8OIPuNUT5rZRfeOcFETcGTjX6ey5Jeg2EHyrpMZY/edit?usp=sharing).
