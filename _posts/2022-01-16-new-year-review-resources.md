...
- [Spreadsheet](https://docs.google.com/spreadsheets/d/1gguNOyTR0jIfh_V-chhdgGoiBgWL5_Q3bGtqxqLs2Yg/edit) template for making your own theory of change.
- [Post](/blog/2020/11/16/theory-of-change-as-a-hypothesis) on holding a theory of change loosely as a hypothesis that you test and iterate on.
- [Post](/blog/2021/12/1/expertmodels) on why you should build models if you want to have a theory of change that actually works.
- [Post](http://www.aaronsw.com/weblog/theoryofchange) with a good example of a theory of change from someone who already has a deep model of the topic.
- [Post](/blog/2020/6/26/five-ways-to-prioritize-better) with a section of examples of theories of change.
...
(This feels particularly relevant to me right now, because I want to be building towards expertise. In five years, I want to have a sound body of knowledge and skills that I can leverage for high-impact opportunities. Clearly visualizing possible futures and [Backchaining](https://docs.google.com/document/d/1KkosNCN8onV5DknfuCcFszPQMYVMm-FKzsWabU4J98c/edit?usp=sharing) to what I need to be doing now feels important for that.)
...
Once you have a big list o’ ideas, spend a while prioritizing them. I recommend using some of [these questions](/blog/2020/11/30/questions-for-prioritizing-projects) and taking inspiration from a couple of [these hamming questions](https://forum.effectivealtruism.org/posts/PtJkdZujMzTi4Aeks/hamming-questions-for-project-planning).

Also do some more rapid testing! This little draft from a while back is probably relevant:

Once you have your theories to test, you want to [**reduce uncertainty at the fastest possible rate**](https://cs.stanford.edu/~jsteinhardt/ResearchasaStochasticDecisionProcess.html). (See also this [post on lean startup approach to early-stage research](https://forum.effectivealtruism.org/posts/jfHPBbYFzCrbdEXXd/how-to-succeed-as-an-early-stage-researcher-the-lean-startup) or any of the lean resources in the theory of change section.)
...
The classic template is [Alex Vermeer’s 8,760 Hours](https://alexvermeer.com/8760hours/). It has a variety of prompts, but the central focus is twelve “life areas” to review and plan for. (Similar alternatives: [review questions](https://docs.google.com/document/d/1aQhXWI3r0-urBEIkisUwBdEzEdfGg-gDqSEzufbQeh0/edit?usp=sharing), [Peter Slattery’s spreadsheet](https://forum.effectivealtruism.org/posts/2zLsLdfaBaiu52EjK/a-spreadsheet-template-for-doing-an-annual-review).)

[Ben Todd’s review template](https://docs.google.com/document/d/1NbhmiIzPa3AKucHvdBRAEmZ4YxzpcX8YAqK5AYtV4E0/edit?usp=sharing) wins for most resources and questions. I found his more start-upy and EA than the others.

Personally, I really liked [Victoria Krakovna’s life review](https://vkrakovna.wordpress.com/2022/01/04/2021-22-new-year-review/) as an example/template. It feels easier and more approachable than some of the others.
...
If you have terrible habits, I recall [The Power of Habit](https://www.goodreads.com/book/show/12609433-the-power-of-habit) by Charles Duhigg being a good starting place. If you want to put a bit more work into making habits sustainable, my post on [reinforcing habits](https://www.lesswrong.com/posts/HLzXMDeEAaRtExo5L/reinforcing-habits) gives you broad pointers. Scott Young has an easy little post on [habits vs projects](https://www.scotthyoung.com/blog/2021/11/02/habits-vs-projects/).
...
2. Trial and error takes a lot of time and attention. I don’t want my clients’ new full-time job to be optimizing their process – I want them to be accomplishing their object-level goals!

My solution is to do a week or so of intense evaluation, then set it aside and go back to focusing on output. This approach was partially inspired by [Tara MacAulay](/blog/2020/4/4/tara-mac-aulay-on-happiness-and-work-self-experimentation-and-prioritization):
...
1. Spend a week evaluating what you spend time on. It can be useful to combine this with a [week intensely tracking your time](/blog/2019/12/15/how-time-tracking-can-help-you-prioritize). Particularly look for areas you do repeatedly or where you spend a lot of time (increasing efficiency on things you do a lot saves you the most time). Email is a common one for most people. Writing, literature reviews, note taking, thinking time are common areas for researchers. Etc.
2. Spend some time trying to identify more efficient methods. You could try:

   1. reading how-to books/blogs on the topic
   2. asking colleagues/friends who you think do it particularly well (tips [here](https://docs.google.com/document/d/1GobnjfeOOJMe4aXLeOWHqth2PBqV5GWNThNObgeka40/edit?usp=sharing) and [here](https://commoncog.com/blog/how-to-learn-tacit-knowledge/) for getting the most value out of interviews)
   3. trying to work backwards from experts/good examples to see what they do differently
   4. trying out a few different approaches
   5. paying attention to each step and looking for ways to improve
   6. deliberate practice ([great example of deliberate practice applied to literature searches)](https://forum.effectivealtruism.org/posts/YCzaCzWwBWPDdwPNY/learnings-about-literature-review-strategy-from-research)
3. Spend some time trying out the most promising ideas you came up with.

…Sorry, these instructions are kind of vague. My internal process is just “hear the topic and ideas pop to the surface.” I feel like [The Lean Startup](https://www.goodreads.com/book/show/10127019-the-lean-startup?ac=1&from_search=true&qid=1gQFnF8ewO&rank=1), [Five Whys](/blog/2021/5/24/five-whys), [How to Measure Anything](https://www.goodreads.com/book/show/444653.How_to_Measure_Anything?ac=1&from_search=true&qid=HacMPBAQbF&rank=1), [Essentialism](https://www.goodreads.com/book/show/18077875-essentialism?ac=1&from_search=true&qid=3FKNJ1t6aC&rank=1), [The Motivation Hacker,](https://www.goodreads.com/book/show/17788725-the-motivation-hacker?ac=1&from_search=true&qid=k9bUUEAVL8&rank=1) and [How to Become a Straight-A Student](https://www.goodreads.com/book/show/253203.How_to_Become_a_Straight_A_Student?ac=1&from_search=true&qid=SHfxso47cg&rank=3) might have been some of the sources that fed into my subconscious idea generator.
...
One such idea of having a “[theme](https://www.youtube.com/watch?v=NVGuFdX5guE)” instead of specific goals. Instead of “read one book a week”, make this the “year of reading” and nudge yourself in that direction.
...
(Maintenance goals: goals that you use to make sure you're not dropping important life areas, even if you’re not trying to change the status quo there. Counter goals: goals that you set so that you're not [goodharting](https://www.lesswrong.com/tag/goodhart-s-law) on some other goal.)

Damon Pourtahmaseb-Sasi has an example of his experience trying out seasons [here](https://www.facebook.com/DaystarEld/posts/10222509683396953).
