...
Really excelling means needing to figure out your own path to success. If it was easy, then many people would follow that path. With that much competition, you would be hard pressed to be one of the best. Hence, you’re more likely to have an impact in neglected career paths because it’s less likely that someone else would have done whatever you did. Similarly, within careers where the steps are fairly straightforward, it often takes doing something [unusual](https://forum.effectivealtruism.org/posts/ExBhGc6xGtLm7m4Mk/thoughts-on-doing-good-through-non-standard-ea-career) to have a large impact.
...
The first step is to form a hypothesis about what is valuable for you to do. What is your best guess about how to cause the change you want to see in the world? I call this hypothesis your theory of change. It is your best guess about what you should do to actually [try](http://mindingourway.com/there-is-no-try/) moving directly towards your [goal](http://mindingourway.com/moving-towards-the-goal/). You can see examples of theories of change [here](http://www.aaronsw.com/weblog/theoryofchange) and [here](/blog/2020/6/26/five-ways-to-prioritize-better).
...
Based on that theory of change, they can be testing things, exploring, and generally bumping into the world. In other words, even if they are uncertain now, they can work their way to a better plan. (Related: [Dive In](http://mindingourway.com/dive-in-2/))
...
For planning your own theory of change, here is a template [spreadsheet](https://docs.google.com/spreadsheets/d/1gguNOyTR0jIfh_V-chhdgGoiBgWL5_Q3bGtqxqLs2Yg/edit?usp=sharing) that includes a real example.
