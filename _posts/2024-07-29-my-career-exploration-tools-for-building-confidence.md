...
1. I think it’s a good case study for [iterated depth decision-making](/blog/2024/5/2/how-to-make-hard-decisions-and-have-impact) in general and reevaluating your career in particular, and
...
I’m a big proponent of [theories of change](/blog/2020/11/16/theory-of-change-as-a-hypothesis), and think that the cause I pick to work on heavily influences how much impact I can make. I also need to match my personal fit to specific career opportunities, so it’s harder than “just” determining what the most important cause is and choosing a job working on that.
...
Tip: Fortunately, there are some good resources to help locate promising cause areas, like [80,000 Hours’ Problem Profiles](https://80000hours.org/problem-profiles), so you can focus most of your energy on finding the best roles for you within one of them.
...
- Look through [80,000 Hours’ list of promising career paths](https://80000hours.org/career-reviews/).
- Look through [Open Phil's grantees](https://www.openphilanthropy.org/giving/grants), which can be filtered by focus area.
- Don’t forget [career capital](https://80000hours.org/articles/career-capital/). You want to be doing high-impact work within the next few years. To do that you might focus on building skills or other resources in the near term. Everything here applies to this as much as for jumping into a directly valuable role.

For those interested, you can read [Kit Harris’s list of 50 ideas from a similar brainstorm he did years ago](https://docs.google.com/document/d/1HYa9QES_BUGw3m6gDc8Syac_ih14dl7HqqU3pQ6ncqg/edit). They span operations, generalist research, technical and strategic AI work, grantmaking, community building, earning to give and cause prioritization research.

# Quick Ranking

In the past, I’ve found a long list of career ideas overwhelming. This time (based on [Kit](https://docs.google.com/document/d/1HYa9QES_BUGw3m6gDc8Syac_ih14dl7HqqU3pQ6ncqg/edit)’s suggestion), I roughly sorted the ideas by how promising they seemed. “Promising” roughly meant [expected impact x how excited I felt about the idea]. Then I selected my top ideas to explore further. This made exploration much more approachable.
...
I didn’t personally find this exercise that useful, but I’m still optimistic that [spreadsheets](https://www.charityentrepreneurship.com/post/using-a-spreadsheet-to-make-good-decisions-five-examples) can sometimes be helpful for decision making.
...
The questions from my project briefs were drawn from this [post](/blog/2020/11/30/questions-for-prioritizing-projects). Specifically I answered:
...
This [post](/blog/2020/11/30/questions-for-prioritizing-projects) has many good questions you can consider. I recommend using a [reasoning transparency](https://www.openphilanthropy.org/reasoning-transparency)-inspired style if you’re struggling, laying out your reasons and the evidence for those conclusions.
...
1. Can I write well enough/fast enough for professional journalism or blogging?
2. Do I and the other stakeholders want to scale up the ARENA pilot?
...
I knew basically nothing about what journalism actually involved day-to-day and I had only a vague theory of change. So my key uncertainties were: What even is journalism? Would journalism be high impact/was there a good [theory of change](/blog/2020/11/16/theory-of-change-as-a-hypothesis)? Would I be a good fit for journalism?
...
Start with the cheapest, easiest tests, and work up to deeper tests. I also recommend doing cheap tests of a few things before going deeper with one, especially if you’re early in your career. [This post](/blog/2024/5/2/how-to-make-hard-decisions-and-have-impact) has advice and tons of case studies on making career decisions.
...
![](/assets/images/Picture1-13cec0.png)

## Tips for you to apply

Here’s an excerpt from my post on [How Much Career Exploration Is Enough?](/blog/2024/4/7/how-much-career-exploration-is-enough)
...
[Template sheet with example](https://docs.google.com/spreadsheets/d/1SzvlfUHhtr_w-xmTVZKXyeYndtHKnOjnIH4ni2hrLLU/edit?usp=sharing)
...
After those nine months, I’ll reevaluate. I’ve got a set of key questions I’m testing, including about [theory of change](/blog/2020/11/16/theory-of-change-as-a-hypothesis) and [personal fit](https://80000hours.org/career-guide/personal-fit/). I also expect I’ll learn tons of things that I don’t know enough now to ask about.
