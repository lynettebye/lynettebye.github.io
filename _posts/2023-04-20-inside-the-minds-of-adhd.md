...
*Note, I mainly focus on the ‘inattentive’ presentation of ADHD, since it’s easiest to miss. If you’d like to learn more about the other types of ADHD, I recommend the youtube channel* [*How to ADHD*](https://www.youtube.com/watch?v=xMWtGozn5jU)*.*
...
Some [research](https://www.sciencedirect.com/science/article/abs/pii/S0890856721020451) shows that people with ADHD are worse at estimating the passage of time. A couple of people said it feels like there is “now” and “not-now,” and planning regarding anything that’s not-now doesn’t happen.
...
Half of the people I spoke with had experienced depression or anxiety that was probably caused by ADHD. This [meta-analysis](https://www.ncbi.nlm.nih.gov/pmc/articles/PMC5567978/) found that about 50% of people with ADHD also have anxiety, and 18% to 53% of people with ADHD have depression (and 9% to 16% of people with depression have ADHD!)
...
The hard thing is that all of this is probably partially true. If I’m tired or don’t really care about some task, I’m going to have more difficulty focusing, ADHD or no ADHD. Working through emotional issues (e.g. [perfectionism](/blog/2023/4/2/rewriting-my-mindset)) did help me get more done.
...
Of the other two, one person tried one medication, which helped her focus but had bad side effects (losing an unhealthy amount of weight and emotional blunting). She hasn’t tried another kind yet. This [meta-analysis](https://pubmed.ncbi.nlm.nih.gov/22983311/) found that 10 percent of adults with ADHD discontinued stimulant medications due to side effects. It’s fairly common to need to try a couple medications before you find the one that works best for you, but it only takes few weeks to test each one.
...
The research on stimulant medication for ADHD finds a large effect size ([Cohen’s D of 0.73](https://drive.google.com/file/d/167AKPAtiNg20BXhtec-_yyz4FyjcGNlV/view?usp=sharing)). Put simply, this means that people with ADHD who take medication report fewer, less intense symptoms on average, than those who don’t. It’s not easy to directly quantify reduction in ADHD symptoms, but for comparison, an intervention to increase IQ with a Cohen’s D of 0.73 would increase IQ by 11 points.
...
This [How to ADHD](https://www.youtube.com/watch?v=rD9qK8-sMGQ) video beautifully captures my internal experience of taking meds vs not.

If you’re worried about side effects or addiction or something else, I highly recommend psychiatrist [Scott Alexander’s page on Adderall](https://lorienpsych.com/2020/10/30/adderall/). I trust Scott’s analysis and feel pretty comfortable accepting risks he compared to “[the risks of eating one extra strip of bacon per day](https://slatestarcodex.com/2017/12/28/adderall-risks-much-more-than-you-wanted-to-know/).” I also checked the [UpToDate](https://drive.google.com/file/d/167AKPAtiNg20BXhtec-_yyz4FyjcGNlV/view?usp=sharing) page for risks of stimulants; their findings broadly seem to agree with Scott’s analysis.
...
If you’re saying, “Yes, **but how do I know if ADHD meds will help *me*?**,” you could take an ADHD questionnaire, like this [one](https://adhd.org.sa/asrs/asrs_en.php). Or you could look back at the Terrible Trifecta:

1. Do you struggle to get started working, frequently procrastinating?
2. When you’re trying to work, do you find yourself getting distracted or having a hard time producing output?
3. Once you’ve made progress on a project without a deadline, do you have a hard time finishing it up?
...
(1) Papers on ADHD cite that stimulants work for 70% to 80% or 90%, often without bothering to give a citation. Ones that offer a citation link to studies like this [one](https://pubmed.ncbi.nlm.nih.gov/15737659/) that found Methylphenidate reduced ADHD symptoms in 76% of patients, compared to 19% of the placebo group. Meanwhile, [StuffThatWorks](https://www.stuffthatworks.health/) aggregates reviews from people with ADHD of which medication they’ve tried and which has been helpful, kind of like Yelp reviews for medical treatments. Based on more than 10,000 reviews each, the website finds that 91% and 86% of users found [Adderall](https://www.stuffthatworks.health/adhd-adults/treatments/dextroamphetamine-saccharate-amphetamine-aspartate-monohydrate-dextroamphetamine-sulfate-amphetamine-sulfate) and [Methylphenidate](https://www.stuffthatworks.health/adhd-adults/treatments/methylphenidate-hcl) (Ritalin) helpful, respectively. This is consistent with psychiatrist [Scott Alexander’s claim](https://lorienpsych.com/2020/10/30/adderall/) that most people slightly prefer Adderall.
